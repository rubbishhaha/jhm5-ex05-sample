-- Migration: insert data into table3f (from CSV)
BEGIN TRANSACTION;
INSERT INTO table3f (jj_no, description, type, day_school_candidates_no, day_school_candidates_cumulative_total, all_candidates_no, all_candidates_cumulative_total) VALUES
